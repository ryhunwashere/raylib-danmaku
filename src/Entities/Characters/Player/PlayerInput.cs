...
internal class PlayerInput
{
    ...
    public bool Shoot => Input.IsKeyDown(KeyboardKey.X);
    public bool StopShoot => Input.IsKeyReleased(KeyboardKey.X);
    public bool IsShooting => Input.IsKeyDown(KeyboardKey.X);
